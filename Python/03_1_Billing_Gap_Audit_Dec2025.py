...
fig.text(
    0.5, 0.89,
    f"70 active subscriptions unbilled  ·  ${total_rev:,.0f} in uncaptured recurring revenue",
...
fig.text(
    0.5, -0.04,
    "⚠  Starter tier accounts for 71% of unbilled subscriptions but only 40% of unbilled revenue. "
    "Business tier drives 27% of unbilled revenue from just 7% of affected subscriptions.",
